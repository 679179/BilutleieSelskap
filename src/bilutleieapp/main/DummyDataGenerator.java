...
public class DummyDataGenerator {
	...
	public static void addGeneratedReservations(List<Utleiekontor> utleiekontorer, List<Kunde> kunder, BilutleieService bilutleieService) {
        ...
        for (int i = 0; i < utleiekontorer.size(); i++) {
            ...
            double dagspris = bilutleieService.getDagspris(bil.getBilKategori());
